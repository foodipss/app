...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:100px;margin-top:41px;">

  <!-- Código da calendarização-->
...
<div class="header">
    ...
    <div id='calendario'>
        ...
        <form id="novo_evento" action="" method="post">
            Nome do Beneficiario: <input type="text" name="nome" required/><br/><br/>            
            Data do turno: <input type="date" name="data" required/><br/><br/>
            Tipo de Evento: <input type="text" name="tipo_evento" required/><br/><br/>   
            <button type="submit" class="btn btn-default"> Registar novo evento </button>
            <button type="button" value="Voltar" class="btn btn-default" onClick="history.go(-1)"> Voltar </button>
        </form>
    </div>
