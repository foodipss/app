...
  
    ...
    <a href="beneficiario.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bullseye fa-fw"></i>  Beneficiarios</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Lista de Beneficiarios </b></h5>
  </header>
...
$query="SELECT idBeneficiario, nome, telefone FROM beneficiario";
...
<tbody>
		...
		<tr>
			<td><?php echo $row['idBeneficiario'];?>
			</td>
			<td>
			<?php echo $row['nome'];?>
			</td>
		...
		<td>	
		<a href="editarBeneficiario.php?idBeneficiario=<?php echo $row['idBeneficiario'];?>">Editar </a>
		</td>
		<td>
			<a href="apagarBeneficiario.php?idBeneficiario=<?php echo $row['idBeneficiario'];?>">Apagar </a>
		</td>
	</tr>
		<?php } ?>
</tbody>
