...
<nav class="text-center">
  <ul class="pager">
    ...
    <?php 
      ...
      <a href="pesquisarV.php?pagina=<?php echo $pagina_anterior; ?>" >
    ...
    <?php 
      ...
      <li><a href="pesquisarV.php?pagina=<?php echo $i; ?>"><?php echo $i ; ?></a></li>
      <?php } ?>
    ...
    <?php 
      ...
      <a href="pesquisarV.php?pagina=<?php echo $pagina_seguinte ; ?>">
    ...
    <?php } ?>
		...
		<form method="POST" action="proc_registarV.php">
			<br>
